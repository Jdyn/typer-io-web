...
const DashboardProfile = props => {
  ...
  return (
    <div className={classes.container}>
      <Header styles={headerStyle}boxShadow="0 5px 20px rgba(35,35,80,.25)" color={theme.primaryWhite} borderRadius="8px 8px 0px 0px" fontSize={24} backgroundColor={"#6772e5"} padding="10px">News</Header>
    </div>
  );
};
